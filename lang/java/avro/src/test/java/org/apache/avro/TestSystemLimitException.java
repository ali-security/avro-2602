...
public class TestSystemLimitException {
  ...
  void helpCheckSystemLimits(Function<Long, Integer> f, String sysProperty, String errorVmLimit,
    ...
    assertEquals(0, (int) f.apply(0L));
    assertEquals(1024, (int) f.apply(1024L));
    assertEquals(MAX_ARRAY_VM_LIMIT, (int) f.apply((long) MAX_ARRAY_VM_LIMIT));
    ...
    // Correct values pass through
    assertEquals(0, (int) f.apply(0L));
    assertEquals(102, (int) f.apply(102L));
